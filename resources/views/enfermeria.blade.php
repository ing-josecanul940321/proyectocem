...
@section('title', 'Enfermeras | CEMSureste')
...
<div class="container">
	<div class="row">
		<div class="col-md-5">
			<h3 class="title-medicos" style="">BUSCA A TU ENFERMERA</h3>
		</div>
		<div class="col-md-7">
			<form action="" class="">			
				<div class="row">						
					<div class="col-md-8">
						<div class="form-group">
							...
							<input type="text" name="apellido-enfermera" id="" class="form-control" placeholder="Apellido">
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-8">
						<div class="form-group">
							<label for="especialidad">BÚSQUEDA POR ESPECIALIDAD</label>
							<select name="especialidad-enfermera" id="exampleselect1" class="form-control">
	...
	<div class="row">
		<div class="col-md-6 busqueda001">
			<div class="row">
			<div class="col-md-4">
			<figure class="figura-medico"><img src="{{ asset('upload/enfermera1.jpg') }}" alt=""></figure>
			</div>
			<div class="col-md-8">
			<h4 id="nombre-medico">Dra. Beatriz Adriana Baeza Gamboa</h4>
			<hr>
